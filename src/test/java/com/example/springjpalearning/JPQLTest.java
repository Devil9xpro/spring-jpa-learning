...
public class JPQLTest {
    ...
    @Test
    public void jqpl_courses_without_students() {
    ...
    @Test
    public void jqpl_courses_with_atleast_2_students() {
    ...
    @Test
    public void jqpl_courses_with_order_by_students() {
    ...
    @Test
    public void jqpl_courses_with_order_by_students_desc() {
    ...
    @Test
    public void jqpl_students_with_passport_in_a_certain_pattern() {
        TypedQuery<Student> query = em.createQuery("Select s from Student s where s.passport.name like '%1234%'",
                Student.class);
